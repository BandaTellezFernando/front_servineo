...
export const tutorialSteps: TutorialStep[] = [
  ...
  },
  {
    ...
    description: "🎥 Mira nuestro video tutorial para aprender todo sobre cómo ser Fixer. Descubre el proceso completo de registro y cómo aprovechar al máximo nuestra plataforma.",
